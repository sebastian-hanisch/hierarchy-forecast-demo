...
PRESET_HELP = {
    ...
    "Viele Depots, kurze Fehlerhistorie": "100 Depots (106 Knoten), Fehlerkovarianz aus 60 Tagen: MinT (Stichprobe) bricht zusammen (Ø-RMSSE über 70, je nach System bis über 2000: die Matrix ist singulär); MinT geschrumpft (λ = 0,45) 0,866 (−13,8 %), WLS (Fehlervarianz) 0,908 (−9,6 %), Bottom-up 0,916 (−8,8 %) gegen 1,004 der Basis, deren Netz-Prognose bei 1,124 liegt.",
