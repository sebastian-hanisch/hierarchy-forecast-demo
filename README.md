...
6. **Die Stichprobenkovarianz bricht zusammen.** 60 Depots (66 Knoten), Fehlerkovarianz aus 60 Tagen: MinT (Stichprobe) erreicht einen Ø-RMSSE von 36,8 gegen 1,008 der Basis (die Matrix hat höchstens Rang 60 bei 66 Knoten). MinT geschrumpft bleibt bei 0,985 (Schrumpfung λ = 0,41); ab 120 Tagen ist auch die Stichprobe brauchbar (1,017).
...
| **Viele Depots, kurze Fehlerhistorie** (Preset, 100 Depots = 106 Knoten, 60 Tage) | MinT (Stichprobe) **2585** (singulär); MinT geschrumpft 0,866 (**−13,8 %**, λ = 0,45), WLS (Fehlervarianz) 0,908 (−9,6 %), Bottom-up 0,916 (−8,8 %) gegen 1,004 der Basis (deren Netz-Ebene liegt bei 1,124). | `test_many_depots_short_history_preset` |
...
| **Fehlerhistorie** (Experiment, 60 Depots, 60 / 120 / 240 / 600 Tage; Ø-RMSSE) | Basis 1,008, Bottom-up 0,983, WLS (Fehlervarianz) 0,990 / 0,988 / 0,989 / 0,989; MinT geschrumpft 0,985 / 0,985 / 0,990 / 0,986 (λ = 0,41 / 0,25 / 0,15 / 0,06); MinT (Stichprobe) **36,8** / 1,017 / 1,015 / 0,995. | `test_history_experiment` |
